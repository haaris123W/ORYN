...
export default function Threads({
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      const { color: currColor, amplitude: currAmplitude, distance: currDistance, enableMouseInteraction: currEnableMouse } = propsRef.current;

      program.uniforms.uColor.value.set(...currColor);
      program.uniforms.uAmplitude.value = currAmplitude;
      program.uniforms.uDistance.value = currDistance;
